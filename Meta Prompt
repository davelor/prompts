...
## Review Criteria:
- **Clarity**: Ensure that every instruction is clear and unambiguous.
- **Specificity**: Add details where needed so that the intended outcome is fully understood.
- **Efficiency**: Streamline the prompt to remove unnecessary words while keeping its purpose intact.
